...
[x y_true y sigma A mask Num_obs] = signal_generator(N, T, K);


[y_BP x_BP t_BP] = my_density_csf('BP', x, y, T, sigma, A, mask, 0.66);
[y_DBP x_DBP t_DBP] = my_density_csf('DBP', x, y, T, sigma, A, mask, 0.2, 0.5, Num_obs, Num_tot);
[y_TBP x_TBP t_TBP] = my_density_csf('TBP', x, y, T, sigma, A, mask, 0.3, 2, Num_obs, Num_tot);
